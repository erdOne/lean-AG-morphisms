...
begin
  convert (set.chain_height_insert_of_forall_lt _ p _).symm,
  { rw set.Iio_insert },
  { intros p e, exact e }
end
...
begin
  ...
  congr,
  ext1 ⟨q, hq⟩,
  rw [submodule.length, subtype.coe_mk, ← set.chain_height_insert_of_forall_lt _ q,
